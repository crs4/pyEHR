...
class DBServices(object):
    ...
    def save_patient_record(self, patient_record):
        """
        >>> dbs = DBServices('localhost', 'test_databaset', 'test_patients_coll', 'test_ehr_coll')
        ...
        with MongoDriver(self.host, self.database, self.patients_collection,
            ...
            if patient_record.record.record_id is None:
                patient_record.record.record_id = driver.add_record(patient_record._to_document())
