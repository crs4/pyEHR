# -*- coding: utf-8 -*-
#
# pyEHR documentation build configuration file, created by
...
try:
    ...
    warnings.warn('could not get release tag, falling back to %s' % fallback_tag)
    release = fallback_tag
...
texinfo_documents = [
  ('index', 'pyEHR', u'pyEHR Documentation',
   u'CRS4', 'pyEHR', 'One line description of project.',
   'Miscellaneous'),
]
